...
public class CommentManagementPanel extends JPanel {
    ...
    private void clearAllComments() {
        ...
        int confirm = JOptionPane.showConfirmDialog(this,
            "Clear ALL data and reset database?\nThis will delete humanitarian_logistics_user.db and create a new empty one.\nThis action cannot be undone!",
            "Confirm Clear All",
            JOptionPane.YES_NO_OPTION,
        ...
        if (confirm == JOptionPane.YES_OPTION) {
            try {
                ...
                String dbFilePath = "humanitarian_logistics_user.db";
                ...
                dbManager = new com.humanitarian.logistics.database.DatabaseManager();
